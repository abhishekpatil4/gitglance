                ...
                <div class="max-w-full flex flex-wrap items-center justify-between mx-auto p-4">
                    ...
                    <div class=" text-lg hidden w-full md:block md:w-auto" id="navbar-default">
                        <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg  md:flex-row md:space-x-8 md:mt-0 md:border-0 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                            ...
                            <li class="flex">
                                <Image src={githubIcon} alt="github icon" class="h-5 w-5 mt-1 mr-1"/>
                                <a href="#" class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Star on GitHub</a>
                            </li>
                        </ul>
                    </div>
                </div>
