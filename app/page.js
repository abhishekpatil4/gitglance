    ...
    <div>
      ...
      <section class="text-center py-48">
        ...
        <form>
              ...
              <div class="relative">
                <input type="search" id="location-search" class=" shadow-md block p-2.5 w-[50rem] z-20 text-xl text-gray-900 bg-white rounded-lg border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-l-gray-700  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-blue-500" placeholder="https://github.com/abhishekpatil4/gitglance" required />
                <button type="submit" class="shadow-md absolute top-0 right-0 p-2.5 text-sm font-medium text-white bg-blue-700 rounded-r-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
